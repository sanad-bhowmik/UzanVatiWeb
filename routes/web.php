...
//Route::any('/foster/notify', 'Front\FosterController@notify')->name('foster.notify');
// ************************************ ADMIN SECTION **********************************************
...
Route::prefix('admin')->group(function() {
  ...
  //new by das
  Route::get('/orders/shop/datatables/{slug}', 'Admin\OrderController@datatablesShop')->name('admin-order-datatables-shop'); //JSON REQUEST
  Route::get('/orders/shop', 'Admin\OrderController@indexShop')->name('admin-order-index-shop');
  Route::post('/excelexport/download','Admin\OrderController@excel')->name('admin.excel');
  ...
  //new by das
  Route::get('/orders/shipped', 'Admin\OrderController@shipped')->name('admin-order-shipped');
  Route::get('/orders/shop/shipped', 'Admin\OrderController@shippedShop')->name('admin-order-shipped-shop');
  ...
  Route::get('/orders/shop/declined', 'Admin\OrderController@declinedShop')->name('admin-order-declined-shop');
  ...
  //new by das
  Route::get('/products/shop/datatables', 'Admin\ProductController@datatablesShop')->name('admin-prod-datatables-shop'); //JSON REQUEST
  Route::get('/products/datatablescampaign', 'Admin\ProductController@datatablescampaign')->name('admin-prod-datatables-campaign');
  
  Route::get('/products', 'Admin\ProductController@index')->name('admin-prod-index');
  Route::get('/products/campaign', 'Admin\ProductController@indexCampaign')->name('admin-prod-campaign');
  //new by das
  Route::get('/products/shop', 'Admin\ProductController@indexShop')->name('admin-prod-index-shop');
  ...
  //new by das
  Route::get('/products/shop/deactive/datatables', 'Admin\ProductController@deactivedatatablesShop')->name('admin-prod-deactive-datatables-shop'); //JSON REQUEST
  Route::get('/products/shop/deactive', 'Admin\ProductController@deactiveShop')->name('admin-prod-deactive-shop');
 ...
 // Route::get('/products/catalogs/', 'Admin\ProductController@catalogs')->name('admin-prod-catalog-index');
  //new by das
  Route::get('/products/shop/catalogs/datatables', 'Admin\ProductController@catalogdatatables')->name('admin-prod-catalog-datatables'); //JSON REQUEST
  Route::get('/products/catalogs/', 'Admin\ProductController@catalogs')->name('admin-prod-catalog-index');
  //22082022
  Route::get('/brand/', 'Admin\BrandController@brands')->name('admin-prod-brand-index');
  Route::get('/brand/list', 'Admin\BrandController@datatables')->name('admin-brand-datatables');
  ...
  Route::get('/brand/activate/{id}', 'Admin\BrandController@activate')->name('admin-brand-activate');
...
//  Route::get('bottom/small/banner/create', 'Admin\BannerController@bottomcreate')->name('admin-sb-create-bottom');
 ...
 Route::get('campaign/active', 'Campaign\CampaignController@active')->name('admin-campaign-active');
 Route::get('campaign/inactive', 'Campaign\CampaignController@inactive')->name('admin-campaign-inactive');
 Route::get('campaign/active/datatables/{status}', 'Campaign\CampaignController@datatables')->name('admin-campaign-datatables'); //JSON REQUEST
 Route::get('campaign/create', 'Campaign\CampaignController@create')->name('admin-campaign-create');
 Route::post('campaign/create', 'Campaign\CampaignController@store')->name('admin-campaign-store');

 Route::get('campaign/edit/{id}', 'Campaign\CampaignController@edit')->name('admin-campaign-edit');
 Route::post('campaign/edit/{id}', 'Campaign\CampaignController@update')->name('admin-campaign-update');
 Route::get('campaign/delete/{id}', 'Campaign\CampaignController@destroy')->name('admin-campaign-delete');
 Route::get('campaign/join/request', 'Admin\CampaignController@joinrequest')->name('admin-campaign-joinrequest');
 Route::get('campaign/join/requestdata', 'Admin\CampaignController@joinrequestdatatable')->name('admin-campaign-joinrequest-datatable');
 Route::get('campaign/join/requestdata/{status}/{type}', 'Admin\CampaignController@joinrequestdatatabletype')->name('admin-campaign-joinrequest-datatable-type');

 Route::get('campaign/join/activelist', 'Admin\CampaignController@joinactive')->name('admin-campaign-joinactive');
 Route::get('campaign/join/inactive', 'Admin\CampaignController@joininactive')->name('admin-campaign-joininactive');
 Route::post('campaign/join/request/{id}', 'Admin\CampaignController@joinupdate')->name('admin-join-request-update');
 Route::get('campaign/join/{id}', 'Admin\CampaignController@join')->name('admin-campaign-join');
...
Route::prefix('user')->group(function() {
  ...
  Route::post('/login', 'User\LoginController@login')->name('user.login.submit');
   //OTP SECTION
 Route::get('/otp','User\RegisterController@sendOtp')->name('send-otp');
 Route::get('/otpVerify','User\RegisterController@otpVerify')->name('verify-otp');
  // User Login End

  // User Register
  Route::get('/register', 'User\LoginController@showRegisterForm')->name('user-register');
  Route::post('/register', 'User\RegisterController@register')->name('user-register-submit');
  Route::post('/registerVendor', 'User\RegisterController@registerVendor')->name('user-register-submit-vendor');
  ...
  Route::get('/orders/paycomplete', 'User\OrderController@ordersPayComplete')->name('user-orders-pay-complete');
...
// User Subscription
  ...
  Route::post('/foster/submit', 'User\FosterController@store')->name('user.foster.submit');
  Route::post('/foster/notify', 'User\FosterController@notify')->name('user.foster.notify');
  Route::post('/foster/cancle', 'User\FosterController@cancle')->name('user.foster.cancle');
...
Route::post('the/Das/ocean/2441139', 'Front\FrontendController@subscription');
...
Route::prefix('vendor')->group(function() {
  ...
  Route::get('/dashboard', 'Vendor\VendorController@dashboard')->name('vendor-dashboard');
    ...
    //Export Section 
    Route::post('/excelexport/download','Vendor\OrderController@excel')->name('vendor.excel');


  //------------ ADMIN ORDER SECTION ------------
  Route::get('/orders', 'Vendor\OrderController@index')->name('vendor-order-index');
  Route::get('/orders/pending', 'Vendor\OrderController@pending')->name('vendor-order-pending');
  Route::get('/orders/processing', 'Vendor\OrderController@processing')->name('vendor-order-processing');
  Route::get('/orders/shipped', 'Vendor\OrderController@shipped')->name('vendor-order-shipped');
  Route::get('/orders/completed', 'Vendor\OrderController@completed')->name('vendor-order-completed');
  Route::get('/orders/canceled', 'Vendor\OrderController@canceled')->name('vendor-order-canceled');
  Route::get('/orders/confirmed', 'Vendor\OrderController@confirmed')->name('vendor-order-confirmed');
  ...
  //------------ VENDOR CAMPAIGN SECTION ------------
  Route::get('/campaign', 'Vendor\CampaignController@index')->name('vendor-campaign-index');
  Route::post('/products/upload/update/{id}', 'Vendor\ProductController@uploadUpdate')->name('vendor-prod-upload-update');
 
  Route::get('/campaign/joined', 'Vendor\CampaignController@index')->name('vendor-campaign-joined');
  Route::get('/campaign/applied', 'Vendor\CampaignController@applied')->name('vendor-campaign-applied');
  Route::get('/campaign/active', 'Vendor\CampaignController@active')->name('vendor-campaign-active');
  Route::get('/campaign/active/datatables/{status}', 'Vendor\CampaignController@datatables')->name('vendor-campaign-datatables'); //JSON REQUEST
  Route::get('/campaign/join/request/datatables/{status}/{type}', 'Vendor\CampaignController@joinrequestdatatable')->name('vendor-campaign-datatables-list'); //JSON REQUEST
  Route::get('/campaign/details/applied/{id}', 'Vendor\CampaignController@details')->name('vendor-campaign-details');
 
  Route::get('/campaign/detailsapply/{id}', 'Vendor\CampaignController@detailsapply')->name('vendor-campaign-details-apply');

  Route::post('/campaign/join', 'Vendor\CampaignController@join')->name('vendor-campaign-join');
  ...
  Route::get('/products/shop', 'Vendor\ProductController@indexshop')->name('vendor-prod-index-shop');
  Route::get('/products/add-from-list', 'Vendor\ProductController@addproductfromlist')->name('vendor-prod-add-from-list');
  
  Route::get('/products/add-from-list-campaign', 'Vendor\ProductController@addproductfromlistcampaign')->name('vendor-prod-add-from-list-campaign');
  Route::get('/products/campaign', 'Vendor\ProductController@indexcampaign')->name('vendor-prod-index-campaign');
  Route::get('/products/store/campaign/{id}', 'Vendor\ProductController@storefromListcampaign')->name('vendor-prod-store-from-list-campaign');
  Route::get('/products/prod-list/campaign', 'Vendor\ProductController@productlistcampaign')->name('vendor-prod-list-campaign');
  Route::get('/products/datatables/campaign', 'Vendor\ProductController@datatablescampaign')->name('vendor-prod-datatables-campaign'); //JSON REQUEST
  Route::get('/products/datatables/shop', 'Vendor\ProductController@datatablesshop')->name('vendor-prod-datatables-shop'); //JSON REQUEST

  Route::get('/products/prod-list', 'Vendor\ProductController@productlist')->name('vendor-prod-list');


  Route::post('/products/store', 'Vendor\ProductController@store')->name('vendor-prod-store');
  Route::get('/products/store/{id}', 'Vendor\ProductController@storefromList')->name('vendor-prod-store-from-list');
  ...
  Route::get('/products/edit/campaign/{id}', 'Vendor\ProductController@editcampaign')->name('vendor-prod-edit-campaign');
...
Route::get('/package/delete/{id}', 'Vendor\PackageController@destroy')->name('vendor-package-delete');
  ...
  Route::post('/foster/submit', 'Vendor\FosterController@store')->name('vendor.foster.submit');
  Route::post('/foster/vendor/notify', 'Vendor\FosterController@notify')->name('vendor.foster.notify');
  Route::post('/foster/cancle', 'Vendor\FosterController@cancle')->name('vendor.foster.cancle');
  ...
  Route::get('/order/{id}/tracks', 'Vendor\OrderTrackController@indexVendor')->name('vendor-order-track'); 
  

  Route::get('/order/{id}/trackload', 'Vendor\OrderTrackController@load')->name('vendor-order-track-load');
  Route::post('/order/track/store', 'Vendor\OrderTrackController@store')->name('vendor-order-track-store');
  Route::get('/order/track/add', 'Vendor\OrderTrackController@add')->name('vendor-order-track-add');
  Route::get('/order/track/edit/{id}', 'Vendor\OrderTrackController@edit')->name('vendor-order-track-edit');
  Route::post('/order/track/update/{id}', 'Vendor\OrderTrackController@update')->name('vendor-order-track-update');
  Route::get('/order/track/delete/{id}', 'Vendor\OrderTrackController@delete')->name('vendor-order-track-delete');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/campaigns', 'Front\CampaignController@campaigns')->name('front.campaigns');
  Route::get('/campaign/{code}', 'Front\CampaignController@campaign')->name('front.campaign');
  Route::get('/campaign/items/{campaign}', 'Front\CampaignController@campaignitems')->name('front.campaign-items');
 // Route::get('/campaignitem/{slug}','Front\CampaignController@product')->name('front.product-campaign');
  //
  ...
  Route::get('/addtobuynowcart','Front\CartController@addtobuynowcart');
  ...
  Route::get('/carts/coupon/check/reload','Front\CartController@couponcheckreload');
  // CART SECTION ENDS

  // CHECKOUT SECTION
  Route::get('/checkout/','Front\CheckoutController@checkout')->name('front.checkout');
  Route::get('/buynow/','Front\CheckoutController@buynow')->name('front.buynow');
  ...
  Route::post('/ssl/cancle', 'Front\SslController@cancle')->name('ssl.cancle');
    ...
    // Foster Routes
    Route::post('/foster/submit', 'Front\FosterController@store')->name('foster.submit');
    Route::post('/foster/buynowsubmit', 'Front\FosterController@buynowstore')->name('foster.buynowsubmit');
   // Route::post('/foster/notify', 'Front\FosterController@notify')->name('foster.notify');
    Route::get('/foster/cancel', 'Front\FosterController@cancel')->name('foster.cancel');


    
    // Bkash Routes
    Route::post('/bkash/submit', 'Front\BkashController@store')->name('bkash.submit');
    Route::get('/bkash/paynow/{invoiceID}', 'Front\BkashController@paynow')->name('bkash.paynow');
    //Route::post('/foster/buynowsubmit', 'Front\FosterController@buynowstore')->name('foster.buynowsubmit');
   // Route::post('/foster/notify', 'Front\FosterController@notify')->name('foster.notify');
    Route::get('/bkash/cancel', 'Front\BkashController@cancel')->name('bkash.cancel');
   //Route::get('/bkash/checkout-url/callback','Front\BkashController@callback')->name('url-callback');
   Route::any('/bkash/notify', 'Front\BkashController@notify')->name('bkash.notify');
   Route::any('/bkash/notify/paynow', 'Front\BkashController@notifypaynow')->name('bkash.notify.paynow');
...
//   Mobile Checkout section
  ...
  Route::get('/search/','Front\CatalogController@search')->name('front.search');
  //NEW DAS
  Route::get('/productSearch/','Front\CatalogController@productSearch')->name('front.productSearch');
  // TAG SECTION ENDS

  // VENDOR SECTION
  Route::get('/store/{category}','Front\VendorController@index')->name('front.vendor');
  Route::get('/campaign/store/{slug}/{code}','Front\VendorController@indexcampaign')->name('front.vendor-campaign');
  Route::post('/vendor/contact','Front\VendorController@vendorcontact');
  Route::get('/campaign/brand/products/{bcode}/{ccode}','Front\CampaignController@brandproducts')->name('front.brand-products');
  // TAG SECTION ENDS
...
Route::get('/{slug}','Front\FrontendController@page')->name('front.page');
  ...
  // PAGE SECTION ENDS
// new by das 
Route::get('/shops/all','Front\FrontendController@allShops')->name('front.allShops');
Route::get('/districts/{slug}','Front\FrontendController@districts')->name('front.districts');
Route::get('/upazilas/{slug}','Front\FrontendController@upazilas')->name('front.upazilas');
