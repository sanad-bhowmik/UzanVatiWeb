...
<li>
        ...
        {{-- <li>
            ...
            <li>
                <a href="{{route('admin-order-confirmed')}}"> {{ __('Confirmed Orders') }}</a>
            </li>
            <li>
            ...
            <li>
                <a href="{{route('admin-order-shipped')}}"> {{ __('Shipped Orders') }}</a>
            </li>
            <li>
            ...
            <li>
                <a href="{{route('admin-order-index-shop')}}"> {{ __('Shop All Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-pending-shop')}}"> {{ __('Shop Pending Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-processing-shop')}}"> {{ __('Shop Processing Orders') }}</a>
            </li>

            <li>
                <a href="{{route('admin-order-confirmed-shop')}}"> {{ __('Shop Picked Orders') }}</a>
            </li>
            
            <li>
                <a href="{{route('admin-order-shipped-shop')}}"> {{ __('Shop Shipped Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-completed-shop')}}"> {{ __('Shop Delivered Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-declined-shop')}}"> {{ __('Shop Cancel Orders') }}</a>
            </li> 
...
@if(Auth::guard('admin')->user()->sectionCheck('products'))
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-prod-index') }}"><span>{{ __('Inventory Products') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-campaign') }}"><span>{{ __('Inventory Campaign Products') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-index-shop') }}"><span>{{ __('Shop Wise Products') }}</span></a>
            </li>
            ...
            <li>
                <a href="{{ route('admin-prod-brand-index') }}"><span>{{ __('Product Brands') }}</span></a>
            </li>
        </ul>
    </li>
...
@if(Auth::guard('admin')->user()->sectionCheck('campaigns'))
<li>
    <a href="#campaigns" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="icofont-crown"></i>{{ __('Campaigns') }}
        <span style="color: rgb(123, 255, 0)">@php  
         
         $pending = App\Models\CampaignJoinRequest::where('status','pending')->get()->count();
        echo $pending>0 ? '('.$pending.')' : '';
        
        @endphp </span>
    </a>
    <ul class="collapse list-unstyled" id="campaigns" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-campaign-active') }}"><span>{{ __('Active Campaigns') }}</span></a>
        </li>
       
        <li>
            <a href="{{ route('admin-campaign-inactive') }}"><span>{{ __('Inactive Campaigns') }}</span></a>
        </li>

        
        <li>
            <a href="{{ route('admin-campaign-joinrequest') }}"><span>{{ __('Campaign Join Requests') }}
        ...
        <li>
            <a href="{{ route('admin-campaign-joinactive') }}"><span>{{ __('Live Campaign Participants') }}</span></a>
        </li>

        <li>
            <a href="{{ route('admin-campaign-joininactive') }}"><span>{{ __('Previous Campaign Participants') }}</span></a>
        </li>
...
@if(Auth::guard('admin')->user()->sectionCheck('messages'))
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="msg" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-message-dispute') }}"><span>{{ __('Disputes/ Issues') }}</span></a>
            </li>
        </ul>
    </li>
