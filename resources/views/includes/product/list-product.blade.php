                                                    ...
                                                    <div class="stars">
                                                        <div class="ratings">
                                                            ...
                                                            <div class="full-stars"
                                                                style="width:{{ App\Models\Rating::ratings($prod->id) }}%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <p class="text"><a
                                                            href="{{ route('front.product', $prod->slug) }}">{{ strlen($prod->name) > 65 ? substr($prod->name, 0, 65) . '...' : $prod->name }}</a>
                                                    </p>
                                                        ...
                                                        <li>
                                                            @if (Auth::guard('web')->check())
                                                                <span href="javascript:;" class="wish add-to-wish"
                                                                    ...
                                                                    title="{{ $langg->lang54 }}"><i
                                                                        class="far fa-heart"></i>
                                                                </span>
                                                            @else
                                                                <span href="javascript:;" class="wish"
                                                                    rel-toggle="tooltip" title="{{ $langg->lang54 }}"
                                                                    data-toggle="modal" id="wish-btn"
                                                                    data-target="#comment-log-reg" data-placement="top">
                                                                    <i class="far fa-heart"></i>
                                                                </span>
                                                            @endif
                                                        </li>
                                                        <li>
                                                            <span class="cart-btn quick-view" rel-toggle="tooltip"
                                                                title="{{ $langg->lang55 }}" href="javascript:;"
