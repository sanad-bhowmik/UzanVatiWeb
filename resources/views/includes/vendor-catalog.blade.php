          ...
          <div class="left-area">
            ...
            <div class="body-area">
                ...
                <ul class="filter-list">
                  ...
                  <li>
                    <div class="content">
                    <a class="category-link" href="{{route('front.vendor',Request::route('category'))}}?cat={{$element->id}}"><i class="fas fa-angle-double-right"></i>  {{$element->slug}}</a>

                            @foreach ($element->subs as $key => $subelement)
                            <div class="sub-content open">
                              <a href="{{route('front.vendor',Request::route('category'))}}?cat={{$element->id}}&subcat={{$subelement->id}}" class="subcategory-link"><i class="fas fa-angle-right"></i>{{$subelement->name}}</a>
                              <!-- @if(!empty($subcat) && $subcat->id == $subelement->id && !empty($subcat->childs))
                                ...
                                <div class="child-content open">
                                  <a href="{{route('front.category', [$element->slug, $subcat->slug, $childcat->slug])}}{{!empty(request()->input('search')) ? '?search='.request()->input('search') : ''}}" class="subcategory-link"><i class="fas fa-caret-right"></i>{{$childcat->name}}</a>
                                </div>
                                @endforeach
                              @endif -->
                            </div>
