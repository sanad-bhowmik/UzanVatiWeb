...
<meta name="facebook-domain-verification" content="h5lqgkeb5ua9u48vwvmtr55k9vhcmx" />
...
<script>
  ...
  fbq('init', '2247230282127272');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=2247230282127272&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
		...
		<div class="container">
			<div class="row align-items-center mainmenu-area-innner">
				<div class="col-lg-3 col-md-6 categorimenu-wrapper remove-padding">
					...
					<div class="categories_menu display-none">
				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
					<nav hidden>
						...
						<ul class="menu">
							...
							@endif
							<li><a href="{{ route('front.campaigns') }}">Campaign
								...
								<img width="45" height="38" src="{{asset('assets/images/new.gif')}}"/>
								@endif
							
							</a></li>
							<li><a href="{{ route('front.allShops') }}">Shops</a></li>
