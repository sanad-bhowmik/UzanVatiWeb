...
<head>
	...
	<body>
					...
					<div class="container-fluid">
						<div class="d-flex justify-content-between">
							...
							<div class="right-eliment">
								<ul class="list">
									<li><h5 class="shop-name">{{Auth::user()->shop_name}}</h5></li>
									<li class="bell-area">
              ...
              @endif
										...
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper">
													<ul>
														<h5>{{ Auth::user()->name ." (".Auth::user()->phone.")" }}</h5>

															<li>
																<a target="_blank" href="{{ route('front.vendor',str_replace(' ', '_', Auth::user()->shop_name)) }}"><i class="fas fa-eye"></i> {{ $langg->lang432 }}</a>
															</li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a target="_blank" href="{{ route('front.vendor',str_replace(' ', '_', Auth::user()->shop_name)) }}" class="wave-effect active"><i class="fas fa-eye mr-2"></i> {{ $langg->lang440 }}</a>
							</li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
									...
									<li>
                                    	<a href="{{route('vendor-order-pending')}}"> Pending Orders</a>

                                	</li>

									
									<li>
                                    	<a href="{{route('vendor-order-processing')}}"> Processing Orders</a>

                                	</li>

									<li>
                                    	<a href="{{route('vendor-order-confirmed')}}"> Picked Orders</a>

                                	</li>

									<li>
                                    	<a href="{{route('vendor-order-shipped')}}"> Shipped Orders</a>
                                	</li>

									<li>
                                    	<a href="{{route('vendor-order-completed')}}"> Delivered Orders</a>
                                	</li>


									
									<li>
                                    	<a href="{{route('vendor-order-canceled')}}"> Canceled Orders</a>
                                	</li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
									...
									<li>
										<a href="{{ route('vendor-prod-add-from-list') }}"><span>{{ $langg->lang445 }}</span></a>
									</li>
									<li>
										<a href="{{ route('vendor-prod-add-from-list-campaign') }}"><span>{{ $langg->lang445 .' Campaign'}}</span></a>
									</li>
									{{-- <li>
										<a href="{{ route('vendor-prod-index') }}"><span>{{ $langg->lang446 }}</span></a>
									</li> --}}
									<li>
										<a href="{{ route('vendor-prod-index-shop') }}"><span>{{ $langg->lang446 .' Shop' }}</span></a>
									</li>
									<li>
										<a href="{{ route('vendor-prod-index-campaign') }}"><span>{{ $langg->lang446 .' Campaign' }}</span></a>
									</li>
									<li>
		...
		$count= DB::table('campaigns')
            ...
            ->selectRaw('campaigns.*')
            ->orderBy('campaigns.id', 'desc')->get()->count();


								@endphp


								<a href="#campaign" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
									<i class="icofont-crown"></i>Campaign 
								...
								<ul class="collapse list-unstyled" id="campaign" data-parent="#accordion">
									...
									<li>
										<a href="{{ route('vendor-campaign-index') }}"><span>Running Campaigns</span> 
									...
									{{-- <li>
										<a href="{{ route('vendor-campaign-joined') }}"><span>Joined Campaigns</span></a>
									</li> --}}
									<li>
										<a href="{{ route('vendor-campaign-applied') }}"><span>Applied Campaigns</span></a>
									</li>
								</ul>
							</li>
							...
							<!-- <li>
								<a href="{{route('vendor-prod-index')}}"><i class="fas fa-eye"></i>Products</a>
							</li> -->
