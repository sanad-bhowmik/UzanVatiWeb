					...
					<div class="user-profile-details">
						<div class="order-history">
							<div class="header-area">
								<h4 class="title">
									{{ $langg->lang378 }}/ Issue <a data-toggle="modal" data-target="#vendorform" class="mybtn1" href="javascript:;"> <i class="fas fa-envelope"></i> {{ $langg->lang379 }} / Issue</a>
								</h4>
							</div>
...
<script type="text/javascript">
     ...
     $.ajax({
        ...
        if(data == 0)
          toastr.error("{{ $langg->something_wrong .' / Order Number is worng' }}");
        else
