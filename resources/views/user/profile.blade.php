                                ...
                                <div class="body">
                                    <div class="edit-info-area-form">
                                        ...
                                        <form id="userform" action="{{route('user-profile-update')}}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                  Name  <input name="name" type="text" class="input-field"
                                                        placeholder="{{ $langg->lang264 }}" required=""
                                                        value="{{ $user->name }}">
                                                </div>
                                                <div class="col-lg-6">
                                                Email    <input name="email" type="email" class="input-field"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                 Phone   <input name="phone" type="text" class="input-field"
                                                        placeholder="{{ $langg->lang266 }}" required=""
                                                        value="{{ $user->phone }}">
                                                </div>
                                                <div class="col-lg-6">
                                                 Fax   <input name="fax" type="text" class="input-field"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                  Country  <select class="input-field" name="country">
                                                ...
                                                <div class="col-lg-6">
                                                  Thana  <input name="state" type="text" class="input-field"
                                                        placeholder="Thana" value="{{ $user->state }}">
                                                </div>
    
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                  District  <input name="city" type="text" class="input-field"
                                                        placeholder="District" value="{{ $user->city }}">
                                                </div>
                                                  <div class="col-lg-6">
                                                    Zip Code 
                                            ...
                                            <div class="col-lg-6">
                                               Address <textarea class="input-field" name="address" required=""
