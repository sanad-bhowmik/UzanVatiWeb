              ...
              <div class="login-form signin-form">
                ...
                <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                  ...
                  <div class="form-input">
                    ...
                    <input type="password" id="loginPass" class="Password" name="password" placeholder="{{ $langg->lang174 }}" required="">
                    <i class="icofont-ui-password"></i>

                    <i  style="left:90%; font-size:22px;" id="eyeOpen" class="icofont-eye-alt show-password"></i>
                    <i  style="left:90%; font-size:22px;" id="eyeClose" class="icofont-eye-blocked hide-password"></i>
...
$("#eyeOpen").on('click', function() {
  var passwordId = $('#loginPass').attr('id');
  $("#" + passwordId).attr("type", "text");
  $(this).addClass('hide-password').removeClass('show-password');
  $('#eyeClose').addClass('show-password').removeClass('hide-password');
  ...
  $(this).addClass('hide-password').removeClass('show-password');
  $('#eyeOpen').addClass('show-password').removeClass('hide-password');
