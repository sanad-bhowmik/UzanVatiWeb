												...
												<div class="row">
													<div class="col-lg-12">
														...
														@if($gs->is_instamojo == 1)
															...
															<a class="nav-link payment" data-val="" data-show="yes" data-form="{{route('api.authorize.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'authorize','slug2' => 0]) }}" id="v-pills-tab9-tab" data-toggle="pill" href="#v-pills-tab9" role="tab" aria-controls="v-pills-tab9" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
															...
															@if($gs->is_mercado == 1)
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('api.mercadopago.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'mercadopago','slug2' => 0]) }}" id="v-pills-tab10-tab" data-toggle="pill" href="#v-pills-tab10" role="tab" aria-controls="v-pills-tab10" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
															...
															<a class="nav-link payment" data-val="flutter" data-show="no" data-form="{{route('api.flutter.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'flutter','slug2' => 0]) }}" id="v-pills-tab11-tab" data-toggle="pill" href="#v-pills-tab11" role="tab" aria-controls="v-pills-tab11" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
															...
															<a class="nav-link payment" data-val="twocheckout" data-show="yes" data-form="{{route('api.twocheckout.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'twocheckout','slug2' => 0]) }}" id="v-pills-tab12-tab" data-toggle="pill" href="#v-pills-tab12" role="tab" aria-controls="v-pills-tab12" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
															...
															<a class="nav-link payment" data-val="ssl" data-show="no" data-form="{{route('api.ssl.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'ssl','slug2' => 0]) }}" id="v-pills-tab13-tab" data-toggle="pill" href="#v-pills-tab13" role="tab" aria-controls="v-pills-tab13" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
															...
															<a class="nav-link payment" data-val="voguepay" data-show="no" data-form="{{route('api.voguepay.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'voguepay','slug2' => 0]) }}" id="v-pills-tab14-tab" data-toggle="pill" href="#v-pills-tab14" role="tab" aria-controls="v-pills-tab14" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
