									...
									<div class="content">
										...
										<div class="billing-address">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<input class="form-control" type="text" name="state" required placeholder="Thana" value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->state : ' ' }}">
												</div>
												<div class="col-lg-6">
													<input class="form-control" type="text" name="city" required placeholder="District/City" value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->city : ' ' }}">
												</div>
												<div class="col-lg-6">
										...
										<div class="ship-diff-addres-area d-none">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text" name="shipping_state" id="shipping_state" placeholder="Thana/Area">
												</div>
											</div>
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="nav flex-column" role="tablist" aria-orientation="vertical">
														...
														{{-- @if(1== 1)
															<a class="nav-link payment" data-val="foster" data-show="no" data-form="{{route('foster.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'foster','slug2' => 0]) }}" id="v-pills-tab13-tab" data-toggle="pill" href="#v-pills-tab13" role="tab" aria-controls="v-pills-tab13" aria-selected="false">
														<div class="icon">
															<span class="radio"></span>
														</div>
														<p>
...
<script type="text/javascript">
	...
	//console.log("form value",$('a.payment:first').data('form'));
...
<script type="text/javascript">
	...
	$('.checkoutform').on('submit', function(e) {
		...
		if (ck == 0) {
			e.preventDefault();
			//
			var total = "{{ Session::has('cart') ? App\Models\Product::convertPrice(Session::get('cart')->totalPrice) : '0.00' }}";
			total = Number(total);
