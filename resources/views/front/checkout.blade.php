											...
											<div class="row">
												...
												<div class="col-lg-6">
													<input class="form-control" type="text" name="address"
														placeholder="Full Address Ex: House no, Road no, Area" required=""
												...
												<div class="col-lg-6">
													<input class="form-control" type="text" name="state" required
														placeholder="Thana" 
														value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->state : ' ' }}">
												</div>
												<div class="col-lg-6">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text" name="shipping_state"
														id="shipping_state" placeholder="Thana/Area">
												</div>
											</div>
