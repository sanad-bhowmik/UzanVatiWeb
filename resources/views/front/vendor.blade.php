...
<!-- Vendor Area Start -->
  <div class="vendor-banner" style="background: url({{  $vendor->shop_image != null ? asset('assets/images/vendorbanner/'.$vendor->shop_image) : '' }}); 
              ...
              {{-- <div id="ajaxContent"> --}}
                <div class="row">
                  ...
                  <div class="page-center category">
                    {!! $vprods->appends(['subcat' => request()->input('subcat'),'cat' => request()->input('cat'),'sort' => request()->input('sort'), 'min' => request()->input('min'), 'max' => request()->input('max')])->links() !!}
                  </div>
              {{-- </div> --}}
            </div>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    min: 0,
    max: 500000,
    values: [{{ isset($_GET['min']) ? $_GET['min'] : '0' }}, {{ isset($_GET['max']) ? $_GET['max'] : '500000' }}],
    step: 5,
