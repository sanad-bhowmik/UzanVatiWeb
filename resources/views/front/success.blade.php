                    ...
                    <div class="content-box section-padding add-product-1">
                        <div class="top-area">
                                <div class="content">
                                    ...
                                    <p class="text">
                                    We'll SMS you an order confirmation with details and tracking info. 
                                    </p>
                                                ...
                                                @if($order->dp == 1)
                                                        ...
                                                        <div class="billing-add-area">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <h5>{{ $langg->lang292 }}</h5>
                                                                    <p>{{ $langg->lang293 }} {{$order->currency_sign}}{{ round(($order->pay_amount + $order->wallet_price)  * $order->currency_value , 2) }}</p>
