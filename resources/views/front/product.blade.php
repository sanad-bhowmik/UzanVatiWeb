      ...
      <div class="col-lg-12">
        <ul class="pages">
          ...
          @if($productt->subcategory_id != null)
            <li><a href="{{ route('front.subcat',['slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug]) }}">{{$productt->subcategory->name}}</a>
            </li>
          @endif
          @if($productt->childcategory_id != null)
            <li><a href="{{ route('front.childcat',['slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug, 'slug3' => $productt->childcategory->slug]) }}">{{$productt->childcategory->name}}</a>
            </li>
          @endif
...
<section class="product-details-page">
  <div class="container">
    ...
    <div class="col-lg-9">
        <div class="row">
          ...
          <div class="xzoom-container">
              <img class="xzoom5" id="xzoom-magnific" src="{{asset('assets/images/products/'.$productt->photo)}}" xoriginal="{{asset('assets/images/products/'.$productt->photo)}}" />
                  ...
                  <div class="product-price">
                    <p class="title">{{ $langg->lang87 }} :</p>
                          <p class="price"><span id="sizeprice">
                            <span class="currencyColor">BDT </span>
                            
                            <span class="priceColor"> {{ $productt->showPrice() }} </span></span>
                            <small><del>{{ $productt->showPreviousPrice() }}</del></small>
                          
                           <span class="discountColor"> {{ $productt->showDiscountPercent() }} </span>
                    ...
                    <div class="product-price">
                      ...
                      <p class="price"> <span class="brandColor"> {{  isset($productt->brand) ?  $productt->brand->brandName() : ''   }} </span> </p>
    ...
    @if( $productt->user_id  != 0)
        <a href="{{ route('front.vendor',str_replace(' ', '_', $productt->user->shop_name)) }}" class="view-stor">{{ $langg->lang249 }}</a>
    @endif
