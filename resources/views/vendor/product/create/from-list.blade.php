...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">CREATE FROM LIST SHOP<a class="add-btn" href=""><i class="fas fa-arrow-left"></i>
                            {{ $langg->lang550 }}</a></h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="{{route('vendor-prod-add-from-list')}}">Create from list</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
               ...
               <span class="search-letter"><a href="{{route('vendor-prod-add-from-list')}}?letter={{$letter}}">{{$letter}}</a></span>
                @endforeach
                <p>
        ...
        <div class="add-product-content">
            ...
            <div class="row"  id="ajaxContent">
                ...
                <div class="card-body text-center">
                    ...
                    <button  onclick="confirm('Sure you want to add this?')" data-href="{{route('vendor-prod-store-from-list',$data->id)}}" class="btn btn-success add-to-shop">Add to Shop</button>
                  </div>
                </div>
    ...
    <script>
        ...
        function productfilter() {
            ...
            if ($("#filterProducts").val() != '') {
                ...
                filterlink = '{{route('vendor-prod-list')}}' + '?products='+$("#filterProducts").val();
