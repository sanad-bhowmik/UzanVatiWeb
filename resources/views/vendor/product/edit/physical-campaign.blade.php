...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"> {{ $langg->lang704 }} <a class="add-btn" href="{{ route('vendor-prod-index-campaign') }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
											<ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="javascript:;">{{ $langg->lang444 }} </a>
												...
												<li>
													<a href="{{ route('vendor-prod-edit-campaign',$data->id) }}">{{ $langg->lang705 }}</a>
												</li>
											</ul>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
					                      ...
					                      <form id="Dasform" action="{{route('vendor-prod-update',$data->id)}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="left-area">
										<h4 class="heading">{{ __('Participated Campaigns') }}</h4>
								</div>
							</div>
							<div class="col-lg-7">
									<select id="campaign" name="campaign_id" >
											<option value="">{{ __('Select Campaign') }}</option>
											  @foreach($campaigns as $camp)
												  <option  value="{{ $camp->id }}" {{$camp->id == $data->campaign_id ? "selected":""}}  >{{$camp->title.' ('.$camp->name.')'}}</option>
											  @endforeach
									 </select>
							</div>
						</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" readonly class="input-field" placeholder="{{ $langg->lang632 }}" name="name" required="" value="{{ $data->name }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<select disabled id="brand" name="brand_id" >
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<select id="cat" disabled  name="category_id" required="">
                                              ...
                                              @endforeach
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<select disabled   id="subcat" name="subcategory_id">
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<select disabled   id="childcat" name="childcategory_id" {{$data->subcategory_id == null ? "disabled":""}}>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<ul class="list">
															<li>
																<input class="checkclick1" name="whole_check" type="hidden" id="whole_check" value="1" {{ !empty($data->whole_sell_qty) ? "checked":"" }}>
						                    ...
						                    <div class="{{ !empty($data->whole_sell_qty) ? "":"showbox" }}">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input id="previous_price" name="previous_price" step="0.1" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{round($data->previous_price * $sign->value , 2)}}" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input id="price" name="price" step="0.1" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="discount_percent" id="discount_percent" step="0.1" type="number" class="input-field" placeholder="Discount percent" value="{{ $data->discount_percent }}"  min="0">
													</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="stock" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{ $data->stock }}">
														<div class="checkbox-wrapper">
															<input type="hidden" name="measure_check" class="checkclick1" id="allowProductMeasurement" value="1" {{ $data->measure == null ? '' : 'checked' }}>
											...
											<div class="{{ $data->measure == null ? 'showbox' : '' }}">
						                        ...
						                        <div class="{{ ($data->meta_tag == null && strip_tags($data->meta_description) == null) ? "showbox":"" }}">
						                          <div class="row">
						                            ...
						                            <div class="col-lg-7">
						                              <ul id="metatags" class="myTags input-field">
...
if(discount_percent>=0 || previous_price>=current_price){

	price = previous_price - Math.round((previous_price*discount_percent)/100)
...
$(document).on('keyup', '#previous_price' ,function() {
		loadprice();
  });
...
if(current_price>=0 && previous_price>=0){
	//console.log(previous_price,current_price);

	price =(100 * ((previous_price-current_price)/previous_price));
	//console.log(previous_price,current_price,price);
}


$('#discount_percent').val(Math.round(price))
