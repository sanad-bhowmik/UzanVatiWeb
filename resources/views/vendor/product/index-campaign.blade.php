							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('vendor-prod-index-campaign') }}">{{ $langg->lang446 }}</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#Dastable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('vendor-prod-datatables-campaign') }}',
               columns: [
                        { data: 'name', name: 'name' },
						{ data: 'category', name: 'category' },
						{ data: 'sub-category', name: 'sub-category' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="{{route('vendor-prod-add-from-list-campaign')}}">'+
