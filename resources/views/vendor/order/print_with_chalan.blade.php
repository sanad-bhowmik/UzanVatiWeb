...
<body onload="window.print();">
        ...
        <div class="invoice__metaInfo">
            <div class="col-lg-6">
                <div class="invoice__orderDetails">
                    ...
                    <span><strong>{{ __('Order Number')}} :</strong> {{ $order->order_number }}</span><br>
                    @if($order->dp == 0)
                        ...
                        <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr class="final-border">
                                    ...
                                    <td>{{$order->currency_sign}}{{ round($order->remain_amount * $order->currency_value , 2) }}
                                    </td>
                                </tr>
    ...
    <div class="container">
        <div class="invoice__title" style="margin-top: 10px;">
            <div class="row">
                <div class="col-sm-6">
                    <div class="invoice__logo text-left">
                        <img src="{{ asset('assets/images/'.$gs->invoice_logo) }}" alt="5Star logo">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="invoice__metaInfo">
            <div class="col-lg-6">
                <div class="invoice__orderDetails" style="text-align: center;">
                    <p><strong>{{ __('Chalan Copy') }} </strong></p>
