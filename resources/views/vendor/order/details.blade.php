...
@section('content')
    <div class="content-area">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <ul class="links">
                                            ...
                                            <li>
                                                <a href="{{ route('vendor-order-index') }}">{{ $langg->lang549 }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="action-list">
                                            ...
                                            Vendor Order Status:   <select id="vendor-status" class="vendor-btn {{ $vorder->status  }}">
                                                   <option
                                                       value="{{ route('vendor-order-status', [$vorder->order_number, 'pending']) }}"
                                                       {{ $vorder->status == 'pending' ? 'selected' : '' }}>
                                                       {{ $langg->lang540 }}</option>

                                                    <option
                                                       value="{{ route('vendor-order-status', [$vorder->order_number, 'processing']) }}"
                                                       {{ $vorder->status  == 'processing' ? 'selected' : '' }}>
                                                       {{ $langg->lang541 }}</option>


                                                   <option
                                                       value="{{ route('vendor-order-status', [$vorder->order_number, 'confirmed']) }}"
                                                       {{ $vorder->status  == 'confirmed' ? 'selected' : '' }}>
                                                       Picked</option>
                                                  
       
                                                   <option
                                                       value="{{ route('vendor-order-status', [$vorder->order_number, 'shipped']) }}"
                                                       {{ $vorder->status  == 'shipped' ? 'selected' : '' }}>Shipped
                                                   </option>
       
                                                   <option
                                                       value="{{ route('vendor-order-status', [$vorder->order_number, 'completed']) }}"
                                                       {{ $vorder->status  == 'completed' ? 'selected' : '' }}>
                                                       Delivered</option>
       
       
                                                   <option
                                                       value="{{ route('vendor-order-status', [$vorder->order_number, 'declined']) }}"
                                                       {{ $vorder->status == 'declined' ? 'selected' : '' }}>
                                                       Cancel</option>
                                               </select>
                                    ...
                                    {{-- <div class="col-md-6">
                                        ...
                                        Admin Order Status: <span class="btn {{ $vorder->status  }}">{{$order->status}}</span>
                ...
                <td width="45%">{{$order->shipping_country == null ? $order->customer_country : $order->shipping_country}}</td>
                                ...
                                <tr>
                                    <th width="45%"><strong>District/City:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%">{{$order->shipping_city == null ? $order->customer_city : $order->shipping_city}}</td>
                                </tr>

                                <tr>
                                    <th width="45%"><strong>Thana/Area:</strong></th>
                                    <th width="10%">:</th>
                                ...
                                @if($product['item']['user_id'] != 0)
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                @if(isset($user))
                                              <a target="_blank" href="{{ $p->campaign_product ==0 ? route('front.product', $p->slug)  : route('front.product-campaign', $p->slug)  }}">{{mb_strlen($product['item']['name'],'utf-8') > 30 ? mb_substr($product['item']['name'],0,30,'utf-8').'...' : $product['item']['name']}}</a>
                                                @else
