...
<div class="content-area">
    ...
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                    <h4 class="heading">{{ $langg->lang237 }} <a class="add-btn" href="{{ route('vendor-package') }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
                    <ul class="links">
                        <li>
                        ...
                        <div class="account-info">
                            <div class="pack-details">
                                ...
                                <br>
                                        ...
                                        <form id="subscribe-form" class="pay-form" action="{{route('vendor-vendor-request-submit')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                            ...
                                            <select name="method" id="option" onchange="meThods(this)" class="option" required="">
                                                ...
                                                @endif
                                                @if($gs->is_foster == 1)
                                                <option value="foster">Foster Payments</option>
                                                @endif
                                                @if($gs->is_voguepay == 1)
...
<script type="text/javascript">
  ...
  $('#mercadopagos').empty();
        ...
        function meThods(val) {
            ...
            var action3  = "{{route('vendor.instamojo.submit')}}";
            var action4  = "{{route('vendor.paystack.submit')}}";
            var action5  = "{{route('vendor.molly.submit')}}";
            var action6  = "{{route('vendor.paytm.submit')}}";
            var action7  = "{{route('vendor.razorpay.submit')}}";
            var action8  = "{{route('vendor.authorize.submit')}}";
            var action9  = "{{route('vendor.mercadopago.submit')}}";
            var action10 = "{{route('vendor.flutter.submit')}}";
            var action11 = "{{route('vendor.twocheckout.submit')}}";
            var action12 = "{{route('vendor.ssl.submit')}}";
            var action13 = "{{route('vendor.voguepay.submit')}}";
            var action14 = "{{route('vendor.foster.submit')}}";
            ...
            if (val.value == "foster") {
               ...
               $('.pay-form').attr('id','subscribe-form');
                ...
                $("#smonth2").prop("required", false);
                $("#syear2").prop("required", false);
                $("#mercadopagos").load(mainurl+'/vendor/mergado-load');
                $("#mercadopagos").show();
                $("#stripes").hide();
                $("#authorize").hide();
                $("#twocheckout").hide();
