                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="Dasformdata" action="{{route('vendor-service-create')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="input-field" name="details" placeholder="{{ $langg->lang514 }}" required></textarea> 
                          </div>
                        </div>
