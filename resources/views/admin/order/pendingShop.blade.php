...
<input type="hidden" id="headerdata" value="{{ __('ORDER') }}">
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ __('Pending Shop Orders') }}</h4>
                                        <ul class="links">
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{ route('admin-order-pending-shop') }}">{{ __('Pending Shop Orders') }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        var table = $('#Dastable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-order-datatables-shop','pending') }}',
               columns: [
