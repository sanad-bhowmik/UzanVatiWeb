                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      <div class="body-area" id="modalEdit">
                        ...
                        <form action="{{ route('admin-gs-update-payment') }}" id="Dasform" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
...
<hr>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-3">
                          <div class="left-area">
                              <h4 class="heading">{{ __('MercadoPago Publishable Key') }} *</h4>

                          </div>
                        </div>
                        <div class="col-lg-6">
                          <textarea class="input-field" name="mercado_publish_key" placeholder="{{ __('MercadoPago Publishable Key') }}" required>{{ $gs->mercado_publish_key }}</textarea>
