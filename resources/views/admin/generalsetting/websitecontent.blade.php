                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      <div class="body-area" id="modalEdit">
                        ...
                        <form action="{{ route('admin-gs-update') }}" id="Dasform" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_buy_now == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-buy-now',1)}}" {{ $gs->is_buy_now == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-buy-now',0)}}" {{ $gs->is_buy_now == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
