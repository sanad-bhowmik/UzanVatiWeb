                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      <div class="body-area" id="modalEdit">
                        ...
                        <form action="{{ route('admin-gs-update-mail') }}" id="Dasform" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                              <select name="mail_engine" class="input-field" required> 
                                <option value="smtp" {{ $gs->mail_engine == 'smtp' ? 'selected' : '' }}>SMTP</option>
                                <option value="sendmail" {{ $gs->mail_engine == 'sendmail' ? 'selected' : '' }}>SENDMAIL</option>
                              </select>
                            </div>
                          </div>
