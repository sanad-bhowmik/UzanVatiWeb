								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="Dasformdata" action="{{ route('admin-user-deposit-update',$data->id) }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
												...
												<div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                                <h6 class="heading">{{ App\Models\Product::vendorConvertPrice($data->balance) }} </h6>
                                                        </div>
                                                    </div>
