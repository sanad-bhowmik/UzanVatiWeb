    ...
    <div class="row row-cards-one">
        ...
        {{-- <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg1">
                <div class="left">
                    <h5 class="title">{{ __('Orders Confirmed!') }} </h5>
                    <span class="number">
                        {{count($confirmed)}}
                    
                    </span>
                    <a href="{{route('admin-order-confirmed')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        {{-- <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg6">
                <div class="left">
                    <h5 class="title">{{ __('Orders Shipped!') }} </h5>
                    <span class="number">
                        {{count($shipped)}}
                    
                    </span>
                    <a href="{{route('admin-order-shipped')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
...
{{-- 
     ...
     <!-- Uzan order status end -->


        <!-- Shop order status starts -->
        <div class="row row-cards-one">
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bgPending">
                <div class="left">
                    <h5 class="title">{{ __('Shop Orders Pending!') }} </h5>
                    <span class="number">
                        {{count($pendingShop)}}
                    
                    </span>
                    <a href="{{route('admin-order-pending-shop')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                    <i class="icofont-clock-time"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bgProcessing">
                <div class="left">
                    <h5 class="title">{{ __('Shop Orders Procsessing!') }}</h5>
                    <span class="number">{{count($processingShop)}}</span>
                    <a href="{{route('admin-order-processing-shop')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bgPicked">
                <div class="left">
                    <h5 class="title">{{ __('Shop Orders Picked!') }} </h5>
                    <span class="number">
                        {{count($confirmedShop)}}
                    
                    </span>
                    <a href="{{route('admin-order-confirmed-shop')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                    <i class="icofont-checked"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bgShipped">
                <div class="left">
                    <h5 class="title">{{ __('Shop Orders Shipped!') }} </h5>
                    <span class="number">
                        {{count($shippedShop)}}
                    
                    </span>
                    <a href="{{route('admin-order-shipped-shop')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                    <i class="icofont-truck-alt"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bgDelivered">
                <div class="left">
                    <h5 class="title">{{ __('Shop Orders Delivered!') }}</h5>
                    <span class="number">{{count($completedShop)}}</span>
                    <a href="{{route('admin-order-completed-shop')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-check-circled"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bgCanceled">
                <div class="left">
                    <h5 class="title">{{ __('Shop Orders Canceled!') }}</h5>
                    <span class="number">{{count($canceledShop)}}</span>
                    <a href="{{route('admin-order-declined-shop')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg4">
                <div class="left">
                    <h5 class="title">{{ __('Shop Total Products!') }}</h5>
                    <span class="number">{{count($productsShop)}}</span>
                    <a href="{{route('admin-prod-index')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
