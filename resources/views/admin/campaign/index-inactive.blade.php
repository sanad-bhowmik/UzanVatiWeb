...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#Dastable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-campaign-datatables',0) }}',
               columns: [
               			{ data: 'banner', name: 'banner' , searchable: false, orderable: false},
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin-campaign-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
