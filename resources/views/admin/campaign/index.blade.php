							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="javascript:;">{{ __("Join Requests") }}</a>
											</li>
...
<div class="modal fade" id="ad-subscription-modal" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#Dastable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-campaign-joinrequest-datatable') }}',
               columns: [
						{ data: 'name', name: 'name' },
