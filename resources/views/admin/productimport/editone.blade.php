								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
					                      ...
					                      <form id="Dasform" action="{{route('admin-import-update',$data->id)}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
				...
				<i class="icofont-upload-alt"></i> {{ __("Upload Image Here") }}
											  ...
											  <div id="f-link" {!! !filter_var($data->photo,FILTER_VALIDATE_URL) ? 'style="display:none"' : '' !!}>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="0.01" type="number" class="input-field" placeholder="{{ __("e.g 20") }}" value="{{round($data->previous_price * $sign->value , 2)}}" min="0">
													</div>
												</div>
