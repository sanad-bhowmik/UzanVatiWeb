								...
								<div class="col-lg-12">
									...
									<div class="heading-area">
										...
										<div class="action-list">
											<select class="process select1 vdroplinks {{ $gs->affilate_product == 1 ? 'drop-success' : 'drop-danger' }}">
											  <option data-val="1" value="{{route('admin-gs-paffilate',1)}}" {{ $gs->affilate_product == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
											  <option data-val="0" value="{{route('admin-gs-paffilate',0)}}" {{ $gs->affilate_product == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
											</select>
										  </div>
									</div>
