...
@section('content')  
          <input type="hidden" id="headerdata" value="LINK">
              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-featuredlink-index') }}">Featured Links</a>
                      </li>
                    </ul>
                </div>
              </div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  ...
  <div class="modal-header d-block text-center">
    <h4 class="modal-title d-inline-block">Confirm Delete</h4>
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center">You are about to delete this Featured Link.</p>
...
{{-- DATA TABLE --}}
    ...
    var table = $('#Dastable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-featuredlink-datatables') }}',
               columns: [
