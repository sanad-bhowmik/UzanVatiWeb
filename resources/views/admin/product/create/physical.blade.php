...
@section('content')
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
					                      ...
					                      <form id="Dasform" action="{{route('admin-prod-store')}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="left-area">
										<h4 class="heading">{{ __('Exclusive Campaign Product ?') }} </h4>
									
								</div>
							</div>
							<div class="col-lg-7">
								<select name="campaign_product">
	...
	<div class="row">
      ...
      <input type="file" name="photo2" onchange="readURL(this)" accept="image/*" class="custom-file-input" id="gm1">
