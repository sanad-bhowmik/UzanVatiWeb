                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="Dasform" action="{{route('admin-sl-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                      @include('includes.admin.form-both') 
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('assets/images/sliders/'.$data->photo):asset('assets/images/noimage.png') }});">
                                  ...
                                  <p class="text">{{ __('Prefered Size: (1920x800) or Relevant Sized Image') }}</p>
                            </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Set Active Status') }} </h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            ...
                            <select name="activeStatus" class="form-control">
                              ...
                              <option  value="1" {{ $data->activeStatus==1 ? 'selected':'' }}> Active</option>
                              <option {{$data->activeStatus==0 ? 'selected' : ''}} value="0">In Active</option>
                            </select>
