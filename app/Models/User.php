...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = ['name','photo','state','zip','residency','city','country','reset_token', 'address', 'phone', 'fax', 'email','password','affilate_code','verification_link','shop_name','owner_name','shop_number','shop_address','reg_number','shop_message','is_vendor','shop_details','shop_image','f_url','g_url','t_url','l_url','f_check','g_check','t_check','l_check','shipping_cost','date','mail_sent','balance','district','division','upazila','union'];
    ...
    {
        return $this->hasMany('App\Models\Deposit','user_id')->orderby('id','desc');
    }
