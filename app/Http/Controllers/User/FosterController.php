...
$redirect_url =url("api/foster/sub/notify") ;
//$redirect_url= action('Front\FosterController@notify');

//dd($redirect_url);
$cancel_url = action('User\FosterController@cancel');
$fail_url = action('User\FosterController@cancel');
...
//end foster
 ...
 public function cancle(Request $request){
    return redirect()->route('user-package')->with('unsuccess','Payment Cancelled.');
}
