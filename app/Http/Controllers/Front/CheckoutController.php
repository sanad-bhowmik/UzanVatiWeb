...
// If a user is Authenticated then there is no problm user can go for checkout
    ...
    return view('front.buynowcheckout', ['products' => $cart->items, 'totalPrice' => $total, 'pickups' => $pickups, 'totalQty' => $cart->totalQty, 'gateways' => $gateways, 'shipping_cost' => 0, 'digital' => $dp, 'curr' => $curr,'shipping_data' => $shipping_data,'package_data' => $package_data, 'vendor_shipping_id' => $vendor_shipping_id, 'vendor_packing_id' => $vendor_packing_id]);             
    }
...
// If guest checkout is Deactivated then display pop up form with proper error message
    ...
    public function cashondelivery(Request $request)
    {
        ...
        $randomNumber = random_int(111,999) + (int)Auth::id() ;
        ...
        if(round($request->total / $curr->value, 2)<500){


            return redirect()->back()->with('unsuccess',"Orderd Amount is less than minimum amount");  
